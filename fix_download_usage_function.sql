-- =====================================================
-- CORREÇÃO DA FUNÇÃO update_download_usage 
-- =====================================================
...
-- =====================================================
-- VERIFICAR E CORRIGIR RLS PARA TABELA COMPANIES
-- =====================================================

-- Verificar policies existentes na tabela companies
SELECT schemaname, tablename, policyname, permissive, roles, cmd, qual 
FROM pg_policies 
WHERE tablename = 'companies';

-- Criar policy para permitir updates da própria empresa
DO $$
BEGIN
    -- Tentar criar a policy se não existir
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'companies' 
        AND policyname = 'Companies can update own data'
    ) THEN
    ...
    ELSE
        RAISE NOTICE 'Policy "Companies can update own data" já existe';
    END IF;
END $$;

-- =====================================================
-- TESTE MANUAL DA FUNÇÃO CORRIGIDA
-- =====================================================

-- Teste com a empresa que está fazendo downloads
DO $$
DECLARE
...
BEGIN
    ...
    SELECT update_download_usage(test_company_id, 1000000) INTO result; -- 1MB teste
