...
-- (Updated with RLS fixes for company registration)
-- =====================================================

-- Ensure the trial plan exists first
INSERT INTO plans (id, name, price, max_storage_gb, max_download_gb_month, max_users, description, stripe_price_id, features)
...
-- View for self-registered companies
