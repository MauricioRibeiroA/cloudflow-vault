-- =====================================================
-- FIX COMPLETO PARA CRIAÇÃO DE USUÁRIOS
-- Execute este SQL inteiro no editor SQL do Supabase
-- =====================================================

-- 1. Fix status constraint to include pending_activation status
...
-- Also update the group_name constraint if it exists
...
-- 2. Add admin_create_user_simple_final function
...
-- 5. Função adicional para listar usuários com status pending_activation
...
-- 6. Função para ativar usuários após eles se registrarem
...
-- 7. Criar trigger para ativação automática (cuidado - só execute se não existir)
DO $$
BEGIN
...
-- 2. Cole no editor SQL do seu projeto Supabase
-- 3. Execute o script inteiro
-- 4. Teste criando um usuário na página /admin
