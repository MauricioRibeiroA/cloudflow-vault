-- SCRIPT CORRIGIDO - SEM COLUNAS INEXISTENTES
...
-- FUNÇÃO PARA COMPLETAR REGISTRO (SEM is_active)
...
BEGIN
    ...
    -- Criar perfil como ADMIN (usando apenas colunas que existem)
...
-- POLÍTICA RLS PARA PERMITIR INSERÇÃO NA TABELA COMPANIES
