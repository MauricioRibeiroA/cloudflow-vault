-- Add HR user type support (without creating test users)
-- 1. Create is_hr function
...
-- 2. Update is_company_admin function to include HR for certain operations
...
-- 3. Update admin_create_user function to allow HR to create regular users only
...
-- 4. Update admin_update_profile function to respect HR limitations
