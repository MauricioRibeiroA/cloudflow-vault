...
-- Comentários das tabelas e funções
...
SELECT 'Sistema de planos criado com sucesso!' as status;
SELECT name, price_brl, storage_limit_gb, download_limit_gb, max_users 
FROM plans 
ORDER BY price_brl;
